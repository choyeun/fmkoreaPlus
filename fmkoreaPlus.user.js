...
(function () {
    ...
    setInterval(() => {
        ...
        for (var i = 0; i < foundClasses.length; i++) {
            ...
            document.getElementsByClassName(classNames[i])[i].innerHTML = "" // 기본 감지 2
        }
        ...
        for (var i = 0; i < foundfindParent.length; i++) {
            ...
            document.getElementsByClassName(foundfindParent[0])[i].innerHTML = "" // 대댓글 감지 3
        }
        ...
        for (var i = 0; i < allElements.length; i++) {
            ...
            document.getElementsByClassName(allElements[0])[i].innerHTML = "" // 대댓글 감지 3
        }
